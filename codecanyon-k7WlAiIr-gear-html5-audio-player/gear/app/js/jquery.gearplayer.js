...
(function ($, window, document, undefined) {
    ...
    var _gConsole = {
        create: function (gSet) {
            ...
            btnDiv.style.width = timeDiv.style.width = playDiv.style.width = consoleSize * 0.4 + 'px';
            btnDiv.style.height = timeDiv.style.height = playDiv.style.height = consoleSize * 0.4 + 'px';
        ...
        var angle = 0,
            ...
            process = function (j) {
                ...
                function selectLabel(n) {
                    ...
                    if (debug){console.log('aqui hacemos el cambio');}
                    // document.getElementById("text").textContent = "esto cambia "+  Math.random() * (10 - 0) + 0;;
                    for (var i = 0, len = labels.length; i < len; i++) {
                        var t = titles[i];
                        var a = authors[i];
                    ...
                    if(n==0){
                        ...
                        document.getElementById("text").textContent = "Mauris in mi posuere nisl aliquam varius congue sit amet metus. Vestibulum consectetur, lacus et consequat varius, mi sem consequat ipsum, vitae porta quam enim eget ex. Nam lacinia arcu nec tincidunt pharetra. Sed non varius urna, hendrerit accumsan arcu. Aliquam non neque a ex vulputate porta et sit amet justo. Donec sit amet vulputate libero. Suspendisse ut mollis ante, sed luctus purus. Cras vitae massa a nulla consequat auctor sed et nunc. Integer rutrum ultricies nulla quis elementum. Cras varius nunc eros, sit amet rhoncus ante sollicitudin eget. Mauris laoreet odio nisl, eu volutpat ex bibendum eu. Donec lacinia orci in elit dignissim sagittis sit amet vitae augue.";
                        document.getElementById("gato").src="img/gatoprueba.png";
                        }
                        if(n==3){
                            
                            document.getElementById("text").textContent = "Vestibulum pretium viverra arcu, sed sagittis eros tempor vel. Morbi suscipit tincidunt dui. Nullam id elementum augue, at varius enim. Phasellus cursus est justo, sit amet vulputate orci pulvinar et. Maecenas sed augue leo. Duis sapien libero, feugiat vitae eros in, lobortis faucibus lacus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Vestibulum sit amet urna volutpat eros ultricies tempus id sit amet urna.";
                            document.getElementById("gato").src="img/gatoprueba1.png";
                        }
                    if(n==3){
                        
                        document.getElementById("gato").src="img/gatoprueba3.png";
                        document.getElementById("text").textContent = "Mauris aliquet eros et nulla posuere, in vehicula tortor efficitur. Praesent in commodo libero. Quisque id vehicula quam. Nam diam lorem, semper consequat ultricies non, faucibus vel ex. Morbi malesuada enim eros, eget pharetra velit ultrices at. Vivamus id ullamcorper diam. Mauris vel justo est. Curabitur dictum dui ut turpis efficitur, nec varius urna volutpat. Suspendisse potenti. Sed hendrerit purus lacus, et scelerisque ex bibendum et. Suspendisse lobortis lorem in condimentum rhoncus.";
                    }
                    if(n==2){
                        document.getElementById("gato").src="img/gatoprueba2.png";
                        
                    document.getElementById("text").textContent = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ipsum tellus, mattis a molestie nec, facilisis sed libero. In hac habitasse platea dictumst. Donec fringilla nisl tortor, posuere tempus quam vestibulum eget. Nulla sed pellentesque tellus. Integer faucibus sem at urna eleifend, cursus congue purus pulvinar. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nullam sit amet tempus arcu. Quisque fermentum erat nibh, sed tempus massa malesuada quis. Suspendisse convallis massa id odio sagittis accumsan. Donec iaculis ac libero a feugiat. Nam aliquam ut ligula id placerat. Proin in velit mi.";
                    }
                    if(n==1){
                        document.getElementById("gato").src="img/gatoprueba4.png";
                        
                    document.getElementById("text").textContent = "Sed quis elit tincidunt, dignissim ipsum ac, euismod augue. Cras ut sodales risus. Aenean maximus diam eget ante ultricies ultricies. Nulla ac tristique nunc. Nullam posuere lobortis ex, quis mattis urna euismod at. Vestibulum in erat dui. Quisque sollicitudin libero justo, in euismod nulla convallis vel. Ut finibus diam sit amet odio molestie commodo. Sed pretium sapien eu dui dignissim ultricies quis at nibh. Etiam velit felis, varius vitae neque vitae, pellentesque auctor quam.";
                    }
                        if (i == n) {
